Adding type definitions for appointments, client data, and sessions to enhance type safety.
```
...
// Client-side AI service calls - these will be handled by backend endpoints
...
// Fallback AI service using Claude via backend
