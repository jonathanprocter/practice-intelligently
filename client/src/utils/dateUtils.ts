...
// Additional utility functions for DailyView
...
export function formatEventTime(event: { startTime: Date | string; endTime: Date | string }): string {
...
export function getDayNavigationName(date: Date): string {
  return date.toLocaleDateString('en-US', {
    ...EASTERN_TIME_OPTIONS,
    weekday: 'long',
    month: 'long',
